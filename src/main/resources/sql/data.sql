...
-- INSERT INTO `skillbox_blog`.`tag2post` (`post_id`, `tag_id`) VALUES ('5', '4');
...
-- INSERT INTO `skillbox_blog`.`global_settings` (`code`, `name`, `value`) VALUES ('MULTIUSER_MODE', 'Многопользовательский режим ', 'YES');
-- INSERT INTO `skillbox_blog`.`global_settings` (`code`, `name`, `value`) VALUES ('POST_PREMODERATION', 'Премодерация постов', 'YES');
-- INSERT INTO `skillbox_blog`.`global_settings` (`code`, `name`, `value`) VALUES ('STATISTICS_IS_PUBLIC', 'Показывать всем статистику блога', 'NO');
-- INSERT INTO `skillbox_blog`.`global_settings` (`code`, `name`, `value`) VALUES ('MULTIUSER_MODE', 'Многопользовательский режим ', 'NO');
-- INSERT INTO `skillbox_blog`.`global_settings` (`code`, `name`, `value`) VALUES ('POST_PREMODERATION', 'Премодерация постов', 'NO');
